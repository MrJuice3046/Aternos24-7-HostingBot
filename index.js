...
function createBot() {
  ...
  try {
    ...
    // Error handler – only force disconnect for timeouts while connected
    bot.on('error', (err) => {
      console.log('[Bot] Error:', err.message);
      if (botState.connected && (err.message.includes('timed out') || err.message.includes('keepalive'))) {
        console.log('[Bot] Timeout while connected – forcing disconnect');
        try { bot.end(); } catch (e) {}
      }
    });
