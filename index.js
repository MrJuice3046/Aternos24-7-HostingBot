...
function getReconnectDelay() {
  ...
  const base = config.utils['auto-reconnect-delay'] || (isRecentDeath ? 120000 : 30000);
...
function createBot() {
  ...
  try {
    ...
    // Connection timeout – if no spawn within 2 minutes, kill and schedule reconnect
...
// ============================================================
// WATCHDOG – keeps the bot alive forever
// ============================================================
setInterval(() => {
  // If the bot is not connected and we are not already trying, force a reconnect
...
console.log('  Minecraft AFK Bot – Immortal');
console.log('═'.repeat(45));
createBot();
